# authenticate,permissions,token, status, response, generics, apiviews 
...
from .models import Bus,Booking,Seat,User
...
class UserBookingView(APIView):
    ...
    def get(self,request,user_id):
        if request.user.id!=user_id:
            return Response({'error':'unauthorizes'},status=status.HTTP_401_UNAUTHORIZED)
